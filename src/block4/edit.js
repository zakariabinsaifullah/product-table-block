...
const Edit = ({ className, attributes, setAttributes }) => {
    const { showBadge, badge, badgeColor, badgeBg, make, model, id, url, alt, row4, row5, row6, row7, row8, showAffBtn, affiliateBtnLabel, afbLink, afbNewTab, afbTab, afbColor, afbBg, containerBg, containerColor, containerTopBorderWidth, containerBottomBorderWidth, containerLeftBorderWidth, containerRightBorderWidth, containerBorderColor, makeHeight, modelHeight, imageHeight, row4Height, row5Height, row6Height, row7Height, row8Height } = attributes;
    // Links condition 
    if( afbNewTab ) {
